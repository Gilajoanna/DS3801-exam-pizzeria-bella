...
function App() {
    ...
    const pasta = [state, setState] = useState (() => [
        {name:"RISOTTO ALLA VENTRICINA", description="Risotto, ventricina salami, tomato, onion, garlic and parmesan", alargenes="MILK, SULPHITES", price= 215 },
        {name:"RISOTTO AI FUNGHI PORCINI", description="Risotto, mushrooms, onions, garlic, white wine, parmesan", alargenes="MILK, SULPHITES", price= 215 },
        ...
        {name:"SPAGHETTI AGLIO OLIO E PEPERONCINO", description="Fresh spaghetti, olive oil, garlic, chilli flakes, parsley and parmesan", alargenes="WHEAT, MILK, CELLERY", price= 185 },
        {name:"LASAGNA DELLA CASA", description="The house lasagne is served with salad and focaccia", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK, CELERY, SULPHITTER", price= 219 },
        {name:"TAGLIATELLE AL BOLOGNAISE", description="Fresh tagliatelle, meat sauce, parmesan and parsley", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK, CELLERY, SOY, SULPHITES", price= 205 },
        {name:"TAGLIATELLE GORGONZOLA", description="Fresh tagliatelle with beef tenderloin, spring onions, chili and gorgonzola sauce", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK, SOY, CELLERY", price= 239 },
        {name:"TAGLIATELLE CON PORCINI", description="Tagliatelle with creamy mushrooms", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK", price= 239 },
        {name:"STROZZAPRETI CON POLLO", description="Fresh strozzapreti, chicken fillet, bacon, peppers, spring onions, garlic, cream and basil", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK, CELERY, SULPHITES", price= 229 }
    ])

    const addOns = [state, setState] = useState (() => [
      {name:"BRUSCHETTA CON AVOCADO E PROSCIUTTO DI PARMA", description="Grilled country bread with avocado, parma ham, cherry tomato, red onion, garlic, pesto rosso and mozzarella", alargenes="WHEAT, RYE, MILK, PINE NUTS", price= 185 },
      {name:"BRUSCHETTA AL POMODORO E BASILICO", description="Grilled country bread with cherry tomato, garlic, basil, olive oil and parmesan", alargenes="WHEAT, RYE, MILK", price= 155 },
      {name:"BRUSCHETTA CON FUNGHI PORCINI", description="Grilled country bread with stone mushroom puree", alargenes="WHEAT, RYE, MILK, SOY", price= 185 },
      {name:"CONFITTO DI QUAGLIA", description="Cofitert quail with quail glace, celery cream, focacciacrust", alargenes="WHEAT, DURUM WHEAT, MILK, CELLERY, SOY, SULPHITES", price= 185 },
      {name:"ANTIPASTO ALL'ITALIANA", description="Parma ham, ventricina salami, marchisio salami with truffle, pecorino, mozzarella, cherry tomato, arugula, olives, capers, aioli and focaccia", alargenes="WHEAT, DURUM WHEAT, EGGS, MILK, PINE NUTS, SULPHITER", price= 345 },
      {name:"CARPACCIO DI VITELLO", description="Thin, raw slices of veal, truffle cream, lemon, olive oil, pickled beets, pine nuts", alargenes="FISH, EGGS, MILK", price= 185 },
      {name:"ZUPPA DI ARAGOSTA", description="Lobster soup served with scallops and herbs", alargenes="WHEAT, MILK, SOY, CELLERY", price= 199 },
      {name:"PESTO ROSSO", description="", alargenes="MILK, CASHEW NUTS", price= 30 },
      {name:"PESTO GENOVESE", description="", alargenes="MILK, PINE CEREALS", price= 30 },
      {name:"GARLIC DRESSING", description="", alargenes="MILK", price= 30 },
      {name:"AIOLI", description="", alargenes="EGG", price= 30 }
    ])
    ...
    const addDrinToCart = (name, description, price) => {
      setState(prevState => {
        return [...prevState, {name, allergens, price}]
      })
    }
